        ...
        <div className="card-elevated p-6 mb-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-sm text-muted-foreground">
              {userProfile?.images_used || 0} {t("dashboard.of")} {userProfile?.images_limit === -1 ? "∞" : userProfile?.images_limit || 10} {t("dashboard.images_used")}
            </span>
          </div>
          {userProfile?.images_limit === -1 ? (
            <div className="text-sm text-primary font-medium">Unlimited usage</div>
          ) : (
            <Progress value={((userProfile?.images_used || 0) / (userProfile?.images_limit || 10)) * 100} className="h-2" />
          )}
        </div>
          ...
          <div className="card-elevated p-6 mb-8 border-primary/20 bg-gradient-to-r from-primary/5 to-primary/10">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-3">You've used all 10 free trial images. Upgrade to continue.</p>
